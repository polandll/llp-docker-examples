...
docker run --rm -it -v /Users/lorinapoland/CLONES/stargate/docker-images/examples/stargate-jwt-auth/scripts:/scripts  \
-v /Users/lorinapoland/CLONES/stargate/docker-images/examples/stargate-jwt-auth/cqlshrc:/.cassandra/cqlshrc  \
